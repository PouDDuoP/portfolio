...
export default function Education() {
  return (
    <Section id="education" title="Educación" subtitle="Formación continua">
            ...
            <div key={cert.id} className="education__card" style={{ '--delay': `${index * 0.1}s` }}>
              ...
              <div className="education__content">
                <div className="education__header">
                  ...
                  {cert.verified && (
                    <span className="education__verified" aria-label="Certificado verificado">
                      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                <p className="education__description">{cert.description}</p>
              </div>
            </div>
          ))}
        </div>
